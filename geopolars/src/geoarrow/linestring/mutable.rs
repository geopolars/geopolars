...
impl MutableLineStringArray {
    pub fn into_arrow(self) -> ListArray<i64> {
        ...
        let list_data_type =
            DataType::LargeList(Box::new(ArrowField::new("coord", struct_data_type, false)));
        ...
        // Offsets
        let offsets: Buffer<i64> = self.offsets.into();
        let offsets_buffer = unsafe { OffsetsBuffer::new_unchecked(offsets) };
